...
class Body extends React.Component {
    constructor(props) {
        super(props);
        this.state = {products: [],cartid: 0,
          userid: (this.props.location && this.props.lacation && this.props.location.state.username) || null};
                ...
                <ul>
                    ...
                    <li>
                        <ul>
                            <li>{item.name}</li>
                            <li>{item.price}</li>
                            <input type="button" value="Add To Cart" onClick={this.handleClick.bind(this,item.item_id)}/>
                        </ul>
                    </li>    
                    ))}
                </ul>
